        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 page-header">
                    ...
                    <h2 class="page-title text-center">Editar Ocorrência</h2>
                </div>
            </div>
            ...
            <div class="row mt-3">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form accept-charset="utf-8" action="{{ route('Ocorrencias.update', ['caso'=>$casoId,'ocorrencia'=>$ocorrencia->id] ) }}"  method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
